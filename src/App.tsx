...
const SUBJECTS = [
  ...
  { id:"maths", code:"MATHS", title:"Mathematics for Computing", color:"#f59e0b", icon:"📐",
    units:[
      ...
      {id:"ma3",unit:3,title:"2D Random Variables",topics:[
        {id:"ma3t1",title:"Correlation & Regression",marks:[5,10,13]},
      ]},
  ...
  { id:"dbms", code:"DBMS", title:"Database Management Systems", color:"#06b6d4", icon:"🗃️",
    units:[
      {id:"db1",unit:1,title:"Relational Model",topics:[
        {id:"db1t1",title:"ER Model & Relational Data Model",marks:[5,10,13]},
        {id:"db1t2",title:"Relational Algebra (Select, Project, Join)",marks:[5,10,13]},
        {id:"db1t3",title:"Normalization 1NF–5NF",marks:[5,10,13]},
      ]},
  ...
  { id:"rm", code:"RM", title:"Research Methodology & IPR", color:"#ec4899", icon:"🔬",
    units:[
      {id:"rm1",unit:1,title:"Research Methodology",topics:[{id:"rm1t1",title:"Types, Approaches & Research Process",marks:[5,10,13]}]},
      {id:"rm2",unit:2,title:"Research Design",topics:[{id:"rm2t1",title:"Experimental Design & Sampling",marks:[5,10,13]}]},
      ...
      {id:"rm4",unit:4,title:"IPR",topics:[{id:"rm4t1",title:"IPR, Trademarks, WIPO, WTO",marks:[5,10,13]}]},
      {id:"rm5",unit:5,title:"Patents",topics:[{id:"rm5t1",title:"Patent Filing, Licensing & Agents",marks:[5,10,13]}]},
    ]},
  { id:"eng", code:"ENG", title:"Technical Communication", color:"#f97316", icon:"💬",
    units:[
      {id:"en1",unit:1,title:"One-to-One Communication",topics:[{id:"en1t1",title:"Telephone & Formal Writing",marks:[5,10]}]},
      {id:"en2",unit:2,title:"One-to-Many Communication",topics:[{id:"en2t1",title:"Memos, Circulars & Notices",marks:[5,10,13]}]},
      {id:"en3",unit:3,title:"Narration",topics:[{id:"en3t1",title:"Formal Letter & Complaint Writing",marks:[5,10,13]}]},
      {id:"en4",unit:4,title:"Description",topics:[{id:"en4t1",title:"Product Description & Essay",marks:[5,10,13]}]},
      {id:"en5",unit:5,title:"Comparison & Contrast",topics:[{id:"en5t1",title:"Analytical Essays",marks:[5,10,13]}]},
    ]},
  { id:"py", code:"PYTHON", title:"Python Programming", color:"#84cc16", icon:"🐍",
    units:[
      ...
      {id:"py3",unit:3,title:"File & Exception Handling",topics:[{id:"py3t1",title:"File Operations & Exceptions",marks:[5,10,13]}]},
      ...
      {id:"py5",unit:5,title:"OOP in Python",topics:[
        ...
        {id:"py5t2",title:"Lab Programs – Recursion & Trees",marks:[5,10,13]},
      ]},
    ]},
];
...
const QB = {
  "ds1t2":[
    {id:"q1",marks:2,question:"Define Stack. What is LIFO? Give one real example.",kp:["Last In First Out","push/pop/peek","Example: plates stack"]},
    {id:"q2",marks:5,question:"Explain Stack operations (push, pop, peek) with algorithm and example.",kp:["LIFO definition","push with overflow","pop with underflow","peek","example diagram"]},
    {id:"q3",marks:10,question:"Explain Stack with array implementation in C. List all applications.",kp:["C code","overflow/underflow","display function","function calls","expression evaluation","undo feature","browser back"]},
    {id:"q4",marks:13,question:"Implement Stack in C. Explain postfix evaluation for '5 3 + 2 *'. List all real-world applications.",kp:["Full C code","postfix algorithm","step trace","all applications","advantages"]},
  ],
  "ds2t1":[
    {id:"q5",marks:5,question:"Explain Binary Tree traversals: Inorder, Preorder, Postorder with example.",kp:["Inorder: Left-Root-Right","Preorder: Root-Left-Right","Postorder: Left-Right-Root","example tree","output of each"]},
    {id:"q6",marks:10,question:"Define Binary Tree. Explain all three traversals with diagram and applications.",kp:["Binary tree definition","inorder traversal","preorder traversal","postorder traversal","diagram","BST inorder gives sorted output","expression tree uses postorder"]},
  ],
  "db1t2":[
    {id:"q7",marks:5,question:"Explain Select and Project operations in Relational Algebra with examples.",kp:["Select = horizontal filter","Project = vertical filter","Select syntax σ(CONDITION)(RELATION)","Project syntax π(ATTRIBUTES)(RELATION)","examples from Student table"]},
    {id:"q8",marks:10,question:"Explain all types of Joins in Relational Algebra with the PLAYER and GAME example.",kp:["Equi-Join definition","Left Outer Join","Right Outer Join","Full Outer Join","example with PLAYER and GAME tables","when to use each"]},
  ],
  "db1t3":[
    {id:"q9",marks:5,question:"What is Normalization? Explain 1NF and 2NF with examples.",kp:["Purpose: remove redundancy","1NF: atomic values, no repeating groups","2NF: 1NF + no partial dependency","example table before and after"]},
    {id:"q10",marks:10,question:"Explain 1NF, 2NF, 3NF with examples. What problems do they solve?",kp:["Redundancy problem","1NF","2NF","3NF: no transitive dependency","example for each","when to stop"]},
  ],
  "oo1t1":[
    {id:"q11",marks:5,question:"Explain Waterfall Model with all phases and a neat diagram.",kp:["All 6 phases","sequential flow","output of each phase","advantages","disadvantages"]},
    {id:"q12",marks:10,question:"Compare Waterfall, Prototyping, and Spiral models. When is each used?",kp:["Waterfall phases","Prototyping cycle","Spiral 4 quadrants","comparison table","selection criteria"]},
  ],
  "py1t2":[
    {id:"q13",marks:5,question:"Explain for loop and while loop in Python with examples.",kp:["for loop syntax","while loop syntax","break & continue","range()","example programs"]},
    {id:"q14",marks:10,question:"Write Python programs using loops, break, continue. Explain recursive functions with factorial example.",kp:["for loop","while loop","break","continue","recursive factorial","base case","recursive case"]},
  ],
};

// ═══════════════════════════════════════════════════════
//  DT LAB ASSIGNMENTS (from document)
// ═══════════════════════════════════════════════════════
const DT_LABS = [
  {
    id:"dt1", title:"Q1 – Manju Restaurant Billing System",
    subject:"Database Technologies Lab",
    parts:[
      {
        label:"i. Create Tables with PK & FK",
        question:"Create CUSTOMER, WAITER, FOOD, CUST_ORDER, ORDER_FOOD with primary key and foreign key constraints.",
        solution:`-- CUSTOMER table
...
-- CUST_ORDER table (ORD_AMT derived, default 0)
CREATE TABLE CUST_ORDER (
    ONO NUMBER(8) PRIMARY KEY,
    ODATE DATE NOT NULL,
    CID NUMBER(5) NOT NULL,
    WID NUMBER(5) NOT NULL,
    ORD_AMT NUMBER(10,2) DEFAULT 0,
...
CREATE TABLE ORDER_FOOD (
    ...
    PRIMARY KEY (ONO, FID),
    FOREIGN KEY (ONO) REFERENCES CUST_ORDER(ONO),
    FOREIGN KEY (FID) REFERENCES FOOD(FID)
);`,
        explain:"We create 5 tables. CUST_ORDER references CUSTOMER and WAITER. ORDER_FOOD has a composite primary key (ONO, FID) and references both CUST_ORDER and FOOD."
      },
      {
        label:"ii. Food with price > average price",
        question:"List the details of FOOD whose price is greater than the average price of all FOODs.",
        solution:`SELECT FID, FNAME, PRICE
FROM FOOD
WHERE PRICE > (SELECT AVG(PRICE) FROM FOOD);`,
        explain:"Subquery finds the average price of all foods. Outer query returns only foods whose price is above that average."
      },
      {
        label:"iii. Customers with more than 3 orders",
        question:"List the details of customers who have placed more than three orders.",
        solution:`SELECT C.CID, C.CNAME, COUNT(O.ONO) AS ORDER_COUNT
FROM CUSTOMER C
JOIN CUST_ORDER O ON C.CID = O.CID
GROUP BY C.CID, C.CNAME
HAVING COUNT(O.ONO) > 3;`,
        explain:"JOIN connects CUSTOMER and CUST_ORDER. GROUP BY groups by customer. HAVING filters groups with more than 3 orders."
      },
      {
        label:"iv. Update ORD_AMT",
        question:"Develop an update statement to update the value of ORD_AMT.",
        solution:`-- Update ORD_AMT = sum of (PRICE × QTY) for each order
UPDATE CUST_ORDER O
SET ORD_AMT = (
    SELECT SUM(F.PRICE * OF.QTY)
    FROM ORDER_FOOD OF
    JOIN FOOD F ON OF.FID = F.FID
    WHERE OF.ONO = O.ONO
)
WHERE EXISTS (
    SELECT 1 FROM ORDER_FOOD WHERE ONO = O.ONO
);`,
        explain:"For each order, we calculate total amount = sum of price × quantity for all food items in that order. The subquery does this calculation."
      },
      {
        label:"v. MongoDB CRUD for FOOD",
        question:"Illustrate CRUD operations in MongoDB for the FOOD relation.",
        solution:`// ── MongoDB CRUD for FOOD collection ──

// CREATE – Insert documents
db.food.insertOne({ fid: 1, fname: "Idly", price: 30 });
db.food.insertMany([
    { fid: 2, fname: "Dosa", price: 50 },
    { fid: 3, fname: "Sambar Rice", price: 60 },
    { fid: 4, fname: "Biryani", price: 120 }
]);

// READ – Find documents
db.food.find();                          // all food items
db.food.find({ price: { $gt: 50 } });   // food with price > 50
db.food.findOne({ fid: 1 });             // find one by fid

// UPDATE – Modify documents
db.food.updateOne(
    { fid: 1 },
    { $set: { price: 35 } }             // update Idly price
);
db.food.updateMany(
    { price: { $lt: 50 } },
    { $set: { category: "starter" } }   // add field to cheap items
);

// DELETE – Remove documents
db.food.deleteOne({ fid: 4 });           // delete Biryani
db.food.deleteMany({ price: { $gt: 100 } }); // delete expensive items`,
        explain:"MongoDB CRUD: insertOne/insertMany to add, find to read, updateOne/updateMany to modify, deleteOne/deleteMany to remove."
      }
    ]
  },
  {
    id:"dt2", title:"Q2 – Bus Reservation System",
    subject:"Database Technologies Lab",
    parts:[
      {
        label:"a. DDL with PK & FK constraints",
        question:"Create BUS, PASSENGER, DRIVER, BOOK_TICKET, DRIVE_ROUTE with appropriate data types and constraints.",
        solution:`CREATE TABLE BUS (
    ROUTENO NUMBER(6) PRIMARY KEY,
    SOURCE VARCHAR2(50) NOT NULL,
    DESTINATION VARCHAR2(50) NOT NULL,
    MILES NUMBER(6,2) NOT NULL
);
...
-- BOOK_TICKET: composite PK (PID, ROUTENO, JOURNEY_DATE)
CREATE TABLE BOOK_TICKET (
    PID NUMBER(8) NOT NULL,
    ROUTENO NUMBER(6) NOT NULL,
...
-- DRIVE_ROUTE: composite PK (DID, ROUTENO, JOURNEY_DATE)
CREATE TABLE DRIVE_ROUTE (
    ...
    FOREIGN KEY (ROUTENO) REFERENCES BUS(ROUTENO)
        ...
        explain:"5 tables. BOOK_TICKET and DRIVE_ROUTE have composite primary keys. Note: A route >300 miles can have 2 drivers — this is handled by the composite PK in DRIVE_ROUTE allowing same route+date with different DID."
      },
      {
        label:"c. Drivers who traveled same route more than 3 times",
        question:"List the details of drivers who have traveled more than three times on the same route.",
        solution:`SELECT D.DID, D.DNAME, DR.ROUTENO, COUNT(*) AS TRIPS
FROM DRIVER D
JOIN DRIVE_ROUTE DR ON D.DID = DR.DID
GROUP BY D.DID, D.DNAME, DR.ROUTENO
HAVING COUNT(*) > 3
ORDER BY D.DID;`,
        explain:"GROUP BY both driver and route, then HAVING COUNT(*) > 3 keeps only those combinations where driver drove same route more than 3 times."
      },
      {
        label:"d. View for passenger journey details",
        question:"Create a view that tracks passenger id, name, route number, journey date and seat number.",
        solution:`CREATE VIEW PASSENGER_JOURNEY AS
SELECT 
    P.PID,
    P.PNAME,
    BT.ROUTENO,
...
-- To use the view:
SELECT * FROM PASSENGER_JOURNEY;
SELECT * FROM PASSENGER_JOURNEY WHERE ROUTENO = 101;`,
        explain:"A VIEW is like a saved query. It doesn't store data — it just shows combined data from PASSENGER and BOOK_TICKET every time you query it."
      },
      {
        label:"e. MongoDB CRUD for BUS",
        question:"Illustrate CRUD operations for the relation BUS using MongoDB.",
        solution:`// ── MongoDB CRUD for BUS collection ──

// CREATE
db.bus.insertOne({
    routeno: 101, source: "Chennai", destination: "Coimbatore", miles: 500
});
db.bus.insertMany([
    { routeno: 102, source: "Chennai", destination: "Madurai", miles: 460 },
    { routeno: 103, source: "Chennai", destination: "Salem", miles: 340 },
    { routeno: 104, source: "Chennai", destination: "Vellore", miles: 140 }
]);

// READ
db.bus.find();                                    // all buses
db.bus.find({ miles: { $gt: 300 } });             // long distance routes
db.bus.find({ source: "Chennai" });               // routes from Chennai
db.bus.findOne({ routeno: 101 });                 // specific route
...
db.bus.updateMany(
    { miles: { $gt: 300 } },
    { $set: { longDistance: true } }
);

// DELETE
db.bus.deleteOne({ routeno: 104 });
db.bus.deleteMany({ miles: { $lt: 100 } });`,
        explain:"Same CRUD pattern as before. $gt means greater than, $lt means less than in MongoDB query language."
      }
    ]
  },
  {
    id:"dt3", title:"Q3 – Company Database",
    subject:"Database Technologies Lab",
    parts:[
      {
        label:"a. DDL with all constraints",
        question:"Create EMPLOYEE, DEPARTMENT, PROJECT, WORKSFOR with PK, FK, Check constraints.",
        solution:`CREATE TABLE DEPARTMENT (
    DEPT_NO NUMBER(4) PRIMARY KEY,
    NAME VARCHAR2(50) NOT NULL,
    MENO NUMBER(8)  -- Manager ENO (FK added after EMPLOYEE)
);
...
CREATE TABLE EMPLOYEE (
    ...
    SENO NUMBER(8),  -- Supervisor ENO (self-referencing FK)
    FOREIGN KEY (DEPT_NO) REFERENCES DEPARTMENT(DEPT_NO),
    FOREIGN KEY (SENO) REFERENCES EMPLOYEE(ENO)
);

-- Now add FK for Manager in DEPARTMENT
ALTER TABLE DEPARTMENT 
ADD CONSTRAINT FK_MENO FOREIGN KEY (MENO) REFERENCES EMPLOYEE(ENO);

CREATE TABLE PROJECT (
    PROJ_NO NUMBER(6) PRIMARY KEY,
    NAME VARCHAR2(50) NOT NULL,
...
CREATE TABLE WORKSFOR (
    ...
    PROJ_NO NUMBER(6) NOT NULL,
    DATE_WORKED DATE NOT NULL,
    HOURS NUMBER(4,2) CHECK (HOURS > 0),
    PRIMARY KEY (ENO, PROJ_NO, DATE_WORKED),
    FOREIGN KEY (ENO) REFERENCES EMPLOYEE(ENO),
    FOREIGN KEY (PROJ_NO) REFERENCES PROJECT(PROJ_NO)
);`,
        explain:"EMPLOYEE has a self-referencing FK (SENO → ENO) for supervisor. DEPARTMENT's MENO is added as FK after EMPLOYEE is created to avoid circular dependency."
      },
      {
        label:"c. Department-wise employee count",
        question:"List the department number, department name and the number of employees in each department.",
        solution:`SELECT D.DEPT_NO, D.NAME AS DEPT_NAME, COUNT(E.ENO) AS EMP_COUNT
FROM DEPARTMENT D
LEFT JOIN EMPLOYEE E ON D.DEPT_NO = E.DEPT_NO
GROUP BY D.DEPT_NO, D.NAME
ORDER BY D.DEPT_NO;`,
        explain:"LEFT JOIN includes departments even with 0 employees. COUNT(E.ENO) counts employees. GROUP BY groups per department."
      },
      {
        label:"d. Employees earning less than average",
        question:"List the details of employees who earn less than the average basic pay of all employees.",
        solution:`SELECT ENO, NAME, GENDER, DESIGNATION, BASIC, DEPT_NO
FROM EMPLOYEE
WHERE BASIC < (SELECT AVG(BASIC) FROM EMPLOYEE)
ORDER BY BASIC DESC;`,
        explain:"Subquery calculates average salary. Outer query returns employees whose BASIC is less than that average."
      },
      {
        label:"e. MongoDB CRUD for EMPLOYEE",
        question:"Illustrate CRUD operations for the relation EMPLOYEE using MongoDB.",
        solution:`// ── MongoDB CRUD for EMPLOYEE collection ──

// CREATE
db.employee.insertOne({
    eno: 1001, name: "Priya", gender: "F",
    dob: new Date("2000-03-12"), doj: new Date("2023-06-01"),
    designation: "Software Engineer",
    basic: 45000, dept_no: 10, pan: "ABCDE1234F"
});
db.employee.insertMany([
    { eno: 1002, name: "Rahul", gender: "M", basic: 52000, dept_no: 10, pan: "XYZAB5678G" },
    { eno: 1003, name: "Ananya", gender: "F", basic: 38000, dept_no: 20, pan: "PQRST9012H" }
]);

// READ
db.employee.find();
db.employee.find({ dept_no: 10 });
db.employee.find({ basic: { $gt: 40000 } });
db.employee.find({ gender: "F" }, { name: 1, basic: 1, _id: 0 });

// UPDATE
db.employee.updateOne(
    { eno: 1001 },
    { $set: { basic: 48000, designation: "Senior Engineer" } }
);
db.employee.updateMany(
    { dept_no: 10 },
    { $inc: { basic: 2000 } }   // $inc = increment by amount
);

// DELETE
db.employee.deleteOne({ eno: 1003 });
db.employee.deleteMany({ basic: { $lt: 30000 } });`,
        explain:"$inc increments a value. Projection {name:1, basic:1, _id:0} means show only name and basic, hide _id."
      }
    ]
  },
  {
    id:"dt4", title:"Q4 – University Exam Controller",
    subject:"Database Technologies Lab",
    parts:[
      {
        label:"a. DDL with all constraints",
        question:"Create STUDENT, BRANCH, DEPARTMENT, COURSE, BRANCH_COURSE, ENROLLS with all constraints.",
        solution:`CREATE TABLE DEPARTMENT (
...
CREATE TABLE STUDENT (
    ROLLNO VARCHAR2(12) PRIMARY KEY,
    NAME VARCHAR2(60) NOT NULL,
    DOB DATE NOT NULL,
    GENDER CHAR(1) CHECK (GENDER IN ('M','F')),
    DOA DATE NOT NULL,
...
CREATE TABLE ENROLLS (
    ROLLNO VARCHAR2(12) NOT NULL,
    CCODE VARCHAR2(8) NOT NULL,
    SESS VARCHAR2(12) NOT NULL,
    GRADE CHAR(2) CHECK (GRADE IN ('S','A','B','C','D','E','U')),
    PRIMARY KEY (ROLLNO, CCODE, SESS),
    FOREIGN KEY (ROLLNO) REFERENCES STUDENT(ROLLNO),
    FOREIGN KEY (CCODE) REFERENCES COURSE(CCODE)
);`,
        explain:"6 tables with all constraints. ENROLLS has composite PK (ROLLNO, CCODE, SESS) allowing re-enrollment for failed courses."
      },
      {
        label:"c. Departments offering more than 3 branches",
        question:"List the details of departments that offer more than three branches.",
        solution:`SELECT D.DNO, D.DNAME, COUNT(B.BCODE) AS BRANCH_COUNT
FROM DEPARTMENT D
JOIN BRANCH B ON D.DNO = B.DNO
GROUP BY D.DNO, D.DNAME
HAVING COUNT(B.BCODE) > 3;`,
        explain:"GROUP BY department, count branches per department, HAVING keeps only those with more than 3."
      },
      {
        label:"d. Departments offering more than 6 courses",
        question:"List the details of departments that offer more than six courses.",
        solution:`SELECT D.DNO, D.DNAME, COUNT(C.CCODE) AS COURSE_COUNT
FROM DEPARTMENT D
JOIN COURSE C ON D.DNO = C.DNO
GROUP BY D.DNO, D.DNAME
HAVING COUNT(C.CCODE) > 6;`,
        explain:"Same pattern — join DEPARTMENT with COURSE, group, and filter with HAVING."
      },
      {
        label:"e. Courses common for more than 3 branches",
        question:"List the details of courses that are common for more than three branches.",
        solution:`SELECT C.CCODE, C.CNAME, C.CREDITS, COUNT(BC.BCODE) AS BRANCH_COUNT
FROM COURSE C
JOIN BRANCH_COURSE BC ON C.CCODE = BC.CCODE
GROUP BY C.CCODE, C.CNAME, C.CREDITS
HAVING COUNT(BC.BCODE) > 3;`,
        explain:"A course is 'common' if it appears in BRANCH_COURSE for multiple branches. Count how many branches have each course."
      },
      {
        label:"f. Students with 'S' grade in more than 2 courses",
        question:"List students who got 'S' grade in more than two courses during a single enrollment session.",
        solution:`SELECT ROLLNO, SESS, COUNT(*) AS S_GRADE_COUNT
FROM ENROLLS
WHERE GRADE = 'S'
GROUP BY ROLLNO, SESS
HAVING COUNT(*) > 2;`,
        explain:"Filter GRADE='S', group by student and session, keep those with more than 2 S grades in that session."
      },
      {
        label:"g. View – Student course completion",
        question:"Create a view tracking roll number, name and number of courses successfully completed.",
        solution:`CREATE VIEW STUDENT_COMPLETION AS
SELECT 
    S.ROLLNO,
    S.NAME,
    COUNT(E.CCODE) AS COURSES_COMPLETED
FROM STUDENT S
LEFT JOIN ENROLLS E ON S.ROLLNO = E.ROLLNO
    AND E.GRADE IN ('S','A','B','C','D','E')  -- successful grades only
GROUP BY S.ROLLNO, S.NAME;

-- Usage
SELECT * FROM STUDENT_COMPLETION ORDER BY COURSES_COMPLETED DESC;`,
        explain:"View joins STUDENT and ENROLLS. Only counts enrollments where grade is a passing grade (not 'U')."
      },
      {
        label:"h. Trigger – Max 6 courses per session",
        question:"Develop a trigger that will not permit a student to enroll for more than six courses during a session.",
        solution:`-- Oracle syntax
...
BEGIN
    ...
    IF V_COUNT >= 6 THEN
        RAISE_APPLICATION_ERROR(-20001, 
            'ERROR: Student ' || :NEW.ROLLNO || 
            ' cannot enroll for more than 6 courses in session ' || :NEW.SESS);
    END IF;
END;
/

-- Test the trigger
-- INSERT that fails (if student already has 6 courses):
INSERT INTO ENROLLS VALUES ('202011101','CA140','NOV2025',NULL);
-- Error: Student cannot enroll for more than 6 courses`,
        explain:"BEFORE INSERT trigger fires before every new enrollment row. It counts existing courses for that student+session. If already 6, it raises an error and stops the insert."
      },
      {
        label:"i. Procedure – Student details and grades",
        question:"Develop a procedure to accept roll number, display student details and all successfully completed courses.",
        solution:`-- Oracle syntax
CREATE OR REPLACE PROCEDURE STUDENT_REPORT(P_ROLLNO IN VARCHAR2)
IS
    V_NAME VARCHAR2(60);
    V_BNAME VARCHAR2(50);
    CURSOR C_COURSES IS
        SELECT E.CCODE, C.CNAME, C.CREDITS, E.SESS, E.GRADE
        FROM ENROLLS E
        ...
        ORDER BY E.SESS;
BEGIN
    -- Get student and branch name
    SELECT S.NAME, B.BNAME 
    INTO V_NAME, V_BNAME
    FROM STUDENT S JOIN BRANCH B ON S.BCODE = B.BCODE
    WHERE S.ROLLNO = P_ROLLNO;
    
    DBMS_OUTPUT.PUT_LINE('=== STUDENT REPORT ===');
    DBMS_OUTPUT.PUT_LINE('Roll No : ' || P_ROLLNO);
    DBMS_OUTPUT.PUT_LINE('Name    : ' || V_NAME);
    DBMS_OUTPUT.PUT_LINE('Branch  : ' || V_BNAME);
    DBMS_OUTPUT.PUT_LINE('--- Completed Courses ---');
    
    FOR REC IN C_COURSES LOOP
        DBMS_OUTPUT.PUT_LINE(
            REC.CCODE || ' | ' || REC.CNAME || 
            ' | Credits: ' || REC.CREDITS || 
            ' | ' || REC.SESS || ' | Grade: ' || REC.GRADE
        );
    END LOOP;
    
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('Student ' || P_ROLLNO || ' not found.');
END;
/

-- Execute the procedure
EXEC STUDENT_REPORT('202011101');`,
        explain:"Procedure takes ROLLNO as input. Fetches student+branch info. Then uses a cursor to loop through all passed courses and prints them."
      }
    ]
  }
];
...
// ═══════════════════════════════════════════════════════
//  PYTHON DSA LAB EXERCISES (all 9)
// ═══════════════════════════════════════════════════════
const PYTHON_DSA_LABS = [
  {
    id:"pdsa1", no:1, title:"Towers of Hanoi using Recursion",
    concept:"Recursion (a function calling itself with a smaller problem)",
    realLife:"Like moving a stack of plates from table A to table C, using table B as help. You must move smaller plates first!",
    starter:`# Towers of Hanoi
# n = number of disks, source, auxiliary, destination

def hanoi(n, source, auxiliary, destination):
    # TODO: Base case - if n == 1, just move disk
    # TODO: Move n-1 disks from source to auxiliary
    # TODO: Move the nth disk from source to destination
    # TODO: Move n-1 disks from auxiliary to destination
    pass

# Test with 3 disks
hanoi(3, 'A', 'B', 'C')`,
    solution:`def hanoi(n, source, auxiliary, destination):
    if n == 1:
...
Move disk 1 from A to C`
  ...
  {
    id:"pdsa2", no:2, title:"Binary Search",
    concept:"Finding a number in a SORTED list by checking the middle, then discarding half",
    realLife:"Like finding a word in dictionary — you open middle, if your word comes before, you look in left half only!",
...
print(f"Found 23 at index: {result}")
result2 = binary_search(nums, 100)
print(f"Found 100 at index: {result2}")`,
...
Found 23 at index: 5
  Checking index 4, value 16
  Checking index 7, value 56
  Checking index 9, value 91
Found 100 at index: -1`
  },
  {
    id:"pdsa3", no:3, title:"Merge Sort",
    concept:"Sort by splitting list into halves, sorting each half, then merging them back",
    realLife:"Like sorting 100 exam papers — split into groups of 10, sort each group, then merge the groups!",
    starter:`# Merge Sort
def merge_sort(arr):
    if len(arr) <= 1:
        return arr
...
def merge(left, right):
    ...
    # TODO: Add smaller element to result
...
After:  [3, 9, 10, 27, 38, 43, 82]`
  ...
  {
    id:"pdsa4", no:4, title:"AVL Tree",
    concept:"A self-balancing Binary Search Tree — automatically rebalances when it gets uneven",
    realLife:"Like a perfectly organised library shelf — when books on one side become too many, it reorganises!",
    starter:`# AVL Tree - Self Balancing BST
class Node:
...
class AVLTree:
    ...
    def get_balance(self, node):
        if not node:
            return 0
        # TODO: return difference of left and right heights
        pass
    
    def insert(self, root, key):
        # TODO: Normal BST insert, then rebalance
        pass
...
tree.inorder(root)
print()`,
    expected:`Inorder traversal (sorted):
10 20 25 30 40`
  },
  {
    id:"pdsa5", no:5, title:"Splay Tree",
    concept:"A BST that moves recently accessed nodes to the root — recently used items are quick to access",
    realLife:"Like your phone's 'Recent Apps' — the app you just used appears first!",
    starter:`# Splay Tree
class SplayNode:
    def __init__(self, key):
        self.key = key
...
class SplayTree:
    ...
    def splay(self, root, key):
        # TODO: Bring key to root using rotations
        pass
    
    def insert(self, key):
        # TODO: Insert key and splay it to root
        pass
    
    def search(self, key):
        # TODO: Search and splay found key to root
        pass

st = SplayTree()
for v in [10, 20, 30, 40, 50]:
    st.insert(v)
print("Search 30:", st.search(30))`,
    solution:`class SplayNode:
    def __init__(self, key):
        self.key = key
        self.left = None
        self.right = None
...
class SplayTree:
    ...
    def search(self, key):
        ...
        if self.root and self.root.key == key:
            print(f"Found {key} at root (splayed!)")
            return True
...
print()
st.search(30)
print("Root after search:", st.root.key)`,
    expected:`Inorder:
10 20 30 40 50
Found 30 at root (splayed!)
Root after search: 30`
  },
  {
    id:"pdsa6", no:6, title:"Red-Black Tree",
    concept:"A self-balancing BST with color rules (Red/Black) to keep the tree balanced",
    realLife:"Like traffic lights (red/green rules) keeping traffic balanced on roads!",
    starter:`# Red-Black Tree
# Properties:
# 1. Every node is RED or BLACK
# 2. Root is always BLACK
# 3. No two RED nodes in a row
# 4. All paths to leaves have same number of BLACK nodes
...
class RedBlackTree:
    def __init__(self):
        self.NIL = RBNode(0)   # Sentinel NIL node
        self.NIL.color = BLACK
        self.root = self.NIL
    
    def insert(self, key):
        # TODO: Insert and fix RB properties
        pass
    
    def inorder(self, node):
        # TODO: print inorder with colors
        pass
...
for v in [10, 20, 30, 15, 5]:
    rbt.insert(v)
print("Inorder (key(R/B)):")
rbt.inorder(rbt.root)
print()`,
    expected:`Inorder (key(R/B)):
5(R) 10(B) 15(R) 20(B) 30(R)`
  },
  {
    id:"pdsa7", no:7, title:"Graphs using Python",
    concept:"A Graph = collection of nodes (vertices) connected by edges. Used in maps, social networks!",
    realLife:"Like Google Maps — cities are nodes, roads are edges. DFS = exploring one road fully before backtracking. BFS = exploring all nearby cities first!",
    starter:`# Graph Implementation with DFS and BFS
...
class Graph:
    ...
    def add_edge(self, u, v):
        # TODO: Add edge between u and v (undirected)
        pass
...
BFS from A: ['A', 'B', 'C', 'D', 'E']`
  ...
  {
    id:"pdsa8", no:8, title:"Python Standard Libraries & Modules",
    concept:"Python comes with built-in tools (modules) — math, random, datetime, collections, etc.",
    realLife:"Like apps pre-installed on your phone — you don't need to install them, just use them!",
    starter:`# Using Python Standard Libraries

# TODO 1: Import math and use sqrt, pi, factorial
import math
# print square root of 144
# print value of pi
# print factorial of 5

# TODO 2: Import random and generate random numbers
import random
# generate a random number between 1 and 100
# pick a random item from a list

# TODO 3: Import datetime
from datetime import datetime, date
# print today's date
# calculate days between two dates

# TODO 4: Use collections.Counter to count characters
from collections import Counter
# count characters in "hello world"

# TODO 5: Create your own module (just define a function here)
def circle_area(radius):
    # TODO: return area of circle using math.pi
    pass`,
...
print("Days since 12-Mar-2001:", age_days)

# ── collections.Counter ──
print("\\n=== Counter ===")
text = "hello world"
count = Counter(text)
print("Character count:", dict(count))
print("Most common 3:", count.most_common(3))
...
=== random module ===
Random 1-100: (any number)
Random fruit: (any fruit)
Shuffled: (shuffled list)

=== datetime module ===
Today: 2026-03-19
Days since 12-Mar-2001: 9139

=== Counter ===
Character count: {'l': 3, 'o': 2, 'h': 1, 'e': 1, ' ': 1, 'w': 1, 'r': 1, 'd': 1}
Most common 3: [('l', 3), ('o', 2), ('h', 1)]

=== Custom function ===
Circle (r=7): Area=153.94, Perimeter=43.98`
  },
  {
    id:"pdsa9", no:9, title:"File Handling & Exception Handling (Real-time App)",
    concept:"Files let programs save data permanently. Exception handling stops programs from crashing!",
    realLife:"Like saving your WhatsApp messages to phone storage (file), and WhatsApp not crashing when internet is off (exception)!",
    starter:`# Real-time App: Student Grade Manager with File Handling
...
def load_students():
    # TODO: Try to open and read students.json
    # If file doesn't exist, return empty dict
    pass

def save_students(data):
    # TODO: Save data dict to students.json
    pass

def add_student(rollno, name, grades):
    # TODO: Load, add student, save
    pass

def get_student(rollno):
    # TODO: Load and return student by rollno
    pass

def calculate_average(grades):
    # TODO: Return average of grades list
    pass

# Test the app
add_student("2024001", "Priya", [85, 90, 78, 92])
add_student("2024002", "Rahul", [70, 65, 80, 75])
print(get_student("2024001"))
print(get_student("9999"))  # Non-existent`,
...
def add_student(rollno, name, grades):
    ...
    students[rollno] = {
        ...
        "added_on": str(datetime.today().date())
    }
    save_students(students)
    print(f"Added student: {name} ({rollno})")
...
def get_student(rollno):
    ...
    if rollno in students:
        ...
        raise KeyError(f"Student {rollno} not found!")

def update_grade(rollno, new_grade):
    try:
        students = load_students()
        if rollno not in students:
            raise KeyError(f"Student {rollno} not found")
        students[rollno]["grades"].append(new_grade)
        grades = students[rollno]["grades"]
        students[rollno]["average"] = round(sum(grades)/len(grades), 2)
        save_students(students)
        print(f"Grade {new_grade} added. New average: {students[rollno]['average']}")
...
print()
try:
    student = get_student("9999")
except KeyError as e:
    print(f"Error caught: {e}")

print()
update_grade("2024001", 95)

print()
all_students = load_students()
print("All students:")
for rid, info in all_students.items():
    print(f"  {rid}: {info['name']} | Avg: {info['average']}")`,
    expected:`=== Student Grade Manager ===

File not found. Starting fresh.
Saved to students.json
Added student: Priya (2024001)
Saved to students.json
Added student: Rahul (2024002)

Found: {'name': 'Priya', 'grades': [85, 90, 78, 92], 'average': 86.25, 'added_on': '2026-03-19'}

Error caught: 'Student 9999 not found!'

Grade 95 added. New average: 88.0

All students:
  2024001: Priya | Avg: 88.0
  2024002: Rahul | Avg: 72.5`
  }
];
...
const saveUD      = (id,d) => localStorage.setItem(`sf_d_${id}`, JSON.stringify(d));
...
function useData(user){
  ...
  const setData=useCallback(d=>{_set(d);if(uid)saveUD(uid,d);},[uid]);
...
`;
function Spin({size=16}){return <div style={{width:size,height:size,border:"2px solid #ffffff18",borderTop:"2px solid #00c9a7",borderRadius:"50%",display:"inline-block",animation:"spin .7s linear infinite",flexShrink:0}}/>;}
function Badge({c="#00c9a7",children,sm}){return <span style={{background:c+"22",color:c,border:`1px solid ${c}44`,borderRadius:6,padding:sm?"1px 7px":"3px 10px",fontSize:sm?9:11,fontWeight:700,letterSpacing:.3,whiteSpace:"nowrap"}}>{children}</span>;}
function Bar({v=0,max=1,c="#00c9a7",h=5}){const p=Math.min(100,max>0?Math.round((v/max)*100):0);return <div style={{background:"#ffffff0a",borderRadius:99,height:h,overflow:"hidden"}}><div style={{width:`${p}%`,height:"100%",background:c,borderRadius:99,transition:"width .5s"}}/></div>;}
function Btn({children,onClick,c="#00c9a7",disabled,full,sm,danger}){const col=danger?"#ef4444":c;return <button disabled={disabled} onClick={onClick} style={{width:full?"100%":"auto",padding:sm?"6px 14px":"10px 22px",background:disabled?"#ffffff05":col+"1e",border:`1px solid ${disabled?"#ffffff10":col+"44"}`,borderRadius:9,color:disabled?"#ffffff22":col,cursor:disabled?"not-allowed":"pointer",fontSize:sm?11:13,fontWeight:600,letterSpacing:.4,display:"inline-flex",alignItems:"center",gap:8,justifyContent:"center",transition:"all .18s",whiteSpace:"nowrap"}}>{children}</button>;}
function Card({children,onClick,style:s={},glow}){return <div onClick={onClick} style={{background:"#ffffff06",border:`1px solid ${glow?glow+"44":"#ffffff0d"}`,borderRadius:14,padding:20,...s,cursor:onClick?"pointer":"default",transition:"all .18s"}} onMouseEnter={e=>{if(onClick){e.currentTarget.style.borderColor=glow?glow+"88":"#ffffff22";e.currentTarget.style.transform="translateY(-2px)";}}} onMouseLeave={e=>{e.currentTarget.style.borderColor=glow?glow+"44":"#ffffff0d";e.currentTarget.style.transform="";}}>{children}</div>;}
...
function AIText({text}){
  ...
  return <div style={{fontSize:13,lineHeight:2,color:"#dde1f0"}}>
    {text.split("\n").map((line,i)=>{
      ...
      const hl=line.replace(/\*\*([^*]+)\*\*/g,'<strong style="color:#fff">$1</strong>').replace(/`([^`]+)`/g,'<code style="background:#ffffff12;padding:1px 7px;borderRadius:4px;fontFamily:monospace;fontSize:11px;color:#84cc16">$1</code>');
...
export default function App(){
  ...
  return <MainApp user={user} data={data} setData={setData} plan={plan}
    apiKey={apiKey} setApiKey={setApiKey} onLogout={logout}
...
// ═══════════════════════════════════════════════════════
//  AUTH — FIXED: no credentials shown, no admin demo for normal
// ═══════════════════════════════════════════════════════
    ...
    setTimeout(()=>{
      ...
      if(mode==="register"){
        ...
        if(email===CONFIG.OWNER_EMAIL&&pass===CONFIG.OWNER_PASSWORD){
          ...
          if(ex){onLogin({...ex,plan:"admin"});setLoading(false);return;}
          const nu={id:`owner_${Date.now()}`,name:"Admin",email,pass,plan:"admin",joined:Date.now()};
          saveUsers([...users,nu]);onLogin(nu);setLoading(false);return;
        }
        const u=users.find(u=>u.email===email&&u.pass===pass);
        if(!u){setErr("Wrong email or password.");setLoading(false);return;}
        onLogin(u);
      }
      setLoading(false);
    },400);
        ...
        <Card style={{padding:26}}>
          <div style={{display:"flex",background:"#ffffff08",borderRadius:9,padding:3,marginBottom:22}}>
            {["login","register"].map(m=>(
              <button key={m} onClick={()=>{setMode(m);setErr("");}}
                style={{flex:1,padding:"9px",background:mode===m?"#ffffff14":"transparent",border:"none",borderRadius:7,color:mode===m?"#fff":"#ffffff55",cursor:"pointer",fontSize:12,fontWeight:mode===m?600:400,transition:"all .2s"}}>
          ...
          {mode==="register"&&(
            <div style={{marginBottom:16}}>
              <div style={{fontSize:10,color:"#ffffff55",letterSpacing:2,marginBottom:7,fontWeight:600}}>YOUR NAME</div>
              <input value={name} onChange={e=>setName(e.target.value)} placeholder="e.g. Priya Rajan"
          ...
          <div style={{marginBottom:16}}>
            <div style={{fontSize:10,color:"#ffffff55",letterSpacing:2,marginBottom:7,fontWeight:600}}>EMAIL ADDRESS</div>
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="your@email.com"
              style={{width:"100%",background:"#ffffff08",border:"1px solid #ffffff18",borderRadius:9,padding:"11px 14px",color:"#dde1f0",fontSize:13,outline:"none"}}/>
          </div>
          <div style={{marginBottom:16}}>
            <div style={{fontSize:10,color:"#ffffff55",letterSpacing:2,marginBottom:7,fontWeight:600}}>PASSWORD</div>
            <input type="password" value={pass} onChange={e=>setPass(e.target.value)} placeholder="••••••••"
              style={{width:"100%",background:"#ffffff08",border:"1px solid #ffffff18",borderRadius:9,padding:"11px 14px",color:"#dde1f0",fontSize:13,outline:"none"}}/>
            {mode==="register"&&<div style={{fontSize:11,color:"#ffffff33",marginTop:5}}>Remember this password — you need it every time you log in</div>}
          </div>
          ...
          {/* FIXED: Only show one demo button - no admin exposed */}
          <div style={{margin:"18px 0 0",borderTop:"1px solid #ffffff0d",paddingTop:16}}>
            ...
            <button onClick={()=>{
              ...
              style={{width:"100%",padding:"10px 14px",background:"#ffffff0a",border:"1px solid #ffffff22",borderRadius:9,color:"#ffffff88",cursor:"pointer",fontSize:12,fontWeight:500,display:"flex",alignItems:"center",justifyContent:"center",gap:6}}>
              👤 Try as Free Student (Demo)
            </button>
          </div>
        </Card>

        <div style={{marginTop:12,background:"#00c9a70a",border:"1px solid #00c9a720",borderRadius:10,padding:14,fontSize:11,color:"#ffffff55",lineHeight:1.85}}>
          🆓 Free: 5 AI calls/day · All 7 subjects · Lab exercises<br/>
          ⚡ Pro ({CONFIG.PRO_PRICE_DISPLAY}/mo): Unlimited AI + mock tests + priority
        </div>
      </div>
    </div>
  );
...
// ═══════════════════════════════════════════════════════
//  MAIN APP — FIXED: API key only asked when needed
// ═══════════════════════════════════════════════════════
function MainApp({user,data,setData,plan,apiKey,setApiKey,onLogout,showSettings,setShowSettings,showPaywall,setShowPaywall,onAdmin}){
  ...
  // FIXED: tryAI only asks for key when AI feature is actually used
  const tryAI=fn=>{
    ...
    <div style={{fontFamily:"'IBM Plex Mono',monospace",background:"#07070e",minHeight:"100vh",color:"#dde1f0",display:"flex",flexDirection:"column"}}>
      ...
      <header style={{borderBottom:"1px solid #ffffff0d",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",background:"#09090f",position:"sticky",top:0,zIndex:99,gap:12}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
          {plan==="free"&&aiLeft!==null&&<div style={{fontSize:11,color:aiLeft>1?"#f59e0b":"#ef4444",whiteSpace:"nowrap"}}>⚡ {aiLeft} AI left</div>}
          <Badge c={planColor}>{plan.toUpperCase()}</Badge>
          {/* FIXED: Admin button ONLY shows for admin users */}
          {onAdmin&&plan==="admin"&&(
            <button onClick={onAdmin} style={{padding:"6px 12px",background:"#f59e0b0f",border:"1px solid #f59e0b44",borderRadius:8,color:"#f59e0b",cursor:"pointer",fontSize:11,fontWeight:600}}>Admin</button>
          )}
          <button onClick={()=>setShowSettings(true)} style={{padding:"6px 14px",background:"#ffffff08",border:"1px solid #ffffff22",borderRadius:8,color:"#ffffff88",cursor:"pointer",fontSize:11,fontWeight:500}}>⚙ Settings</button>
      ...
      <nav style={{borderBottom:"1px solid #ffffff08",padding:"0 16px",display:"flex",gap:2,background:"#0a0a12",overflowX:"auto"}}>
        {NAV.map(n=>(
          <button key={n.id} onClick={()=>setTab(n.id)} style={{background:"transparent",border:"none",color:tab===n.id?"#00c9a7":"#ffffff55",cursor:"pointer",padding:"10px 14px",fontSize:11,letterSpacing:.6,fontWeight:tab===n.id?600:400,borderBottom:tab===n.id?"2px solid #00c9a7":"2px solid transparent",whiteSpace:"nowrap",transition:"all .18s"}}>
            {n.icon} {n.label}
          </button>
        ))}
      </nav>
...
function PaywallModal({user,plan,onClose}){
  ...
  const pay=()=>{
    if(!CONFIG.RAZORPAY_KEY||CONFIG.RAZORPAY_KEY==="rzp_test_XXXX"){
      setErr("Payments not configured yet. The owner needs to add a Razorpay key. Please contact them.");
      return;
    }
    setLoading(true);
    ...
    script.onload=()=>{
      new window.Razorpay({
        key:CONFIG.RAZORPAY_KEY,amount:CONFIG.PRO_PRICE,currency:"INR",
        name:"StudyForge Pro",description:"Unlimited AI study for MCA Sem 1",
        prefill:{name:user.name,email:user.email},theme:{color:"#00c9a7"},
        handler:(response)=>{
          const users=getUsers();
          saveUsers(users.map(u=>u.id===user.id?{...u,plan:"pro",paidAt:Date.now()}:u));
    ...
    script.onerror=()=>{setLoading(false);setErr("Could not load payment. Check internet connection.");};
      ...
      <Card style={{width:"100%",maxWidth:460,padding:28}}>
        ...
        {done?(
          <div style={{textAlign:"center",padding:30}}>
            ...
            <div style={{color:"#ffffff44",fontSize:12,marginTop:8}}>Reloading your account...</div>
          </div>
        ):(
          <>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:22}}>
              <Card style={{padding:16,borderColor:"#ffffff18"}}>
                ...
                <div style={{fontSize:11,color:"#ffffff44",marginTop:10,lineHeight:1.85}}>5 AI calls/day<br/>2 mock tests<br/>All subjects</div>
              </Card>
              <Card style={{padding:16,borderColor:"#00c9a777",background:"#00c9a708"}}>
                ...
                <div style={{fontSize:11,color:"#ffffff88",marginTop:10,lineHeight:1.85}}>
                  <strong style={{color:"#00c9a7"}}>Unlimited</strong> AI<br/>
                  <strong style={{color:"#00c9a7"}}>Unlimited</strong> tests<br/>
                  Hints + Progress sync
                </div>
              </Card>
            </div>
            {err&&<div style={{background:"#f59e0b0e",border:"1px solid #f59e0b33",borderRadius:10,padding:13,fontSize:12,color:"#fcd34d",marginBottom:14,lineHeight:1.7}}>⚠ {err}</div>}
            <Btn full onClick={pay} disabled={loading} c="#00c9a7">
              {loading?<><Spin/> Opening payment...</>:"Pay ₹99 via UPI / Card / Net Banking"}
            </Btn>
            <div style={{marginTop:12,fontSize:11,color:"#ffffff33",textAlign:"center"}}>Razorpay · UPI · Cards · Net Banking · Wallets</div>
          </>
        )}
      </Card>
    </div>
...
function AdminDashboard({user,onBack,onLogout}){
  const users=getUsers();
  const realUsers=users.filter(u=>!u.id.startsWith("demo_")&&u.plan!=="admin");
  const proUsers=realUsers.filter(u=>u.plan==="pro");
  const revenue=proUsers.length*99;
  const totalAI=users.reduce((s,u)=>{const d=getUserData(u.id);return s+Object.values(d.aiUsage||{}).reduce((a,b)=>a+b,0);},0);
        ...
        <div className="fade">
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,marginBottom:24}}>
            {[
              ...
              {l:"Total Students",v:realUsers.length,c:"#7c3aed",s:`${proUsers.length} pro · ${realUsers.filter(u=>u.plan==="free").length} free`},
              {l:"AI Calls",v:totalAI,c:"#f59e0b",s:"all users total"},
          ...
          <Card style={{marginBottom:22,background:"#00c9a708",borderColor:"#00c9a730"}}>
            <div style={{fontWeight:600,color:"#00c9a7",marginBottom:12,fontSize:13}}>💰 PROFIT ESTIMATE</div>
            ...
            <div style={{fontSize:11,color:"#ffffff33"}}>50 users → ₹{Math.round(50*99*0.85)}/mo · 200 users → ₹{Math.round(200*99*0.85)}/mo</div>
          </Card>
          <div style={{fontWeight:600,color:"#fff",marginBottom:12,fontSize:14}}>All Students ({realUsers.length})</div>
          <Card style={{padding:0,overflow:"hidden"}}>
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
              ...
              <tbody>
                {realUsers.length===0?(
                  <tr><td colSpan={5} style={{padding:30,textAlign:"center",color:"#ffffff22",fontSize:12}}>No students yet. Share your app link to get users!</td></tr>
                ):realUsers.map(u=>{
                  ...
                  return (
                    <tr key={u.id} style={{borderBottom:"1px solid #ffffff06"}}
                      ...
                      <td style={{padding:"11px 16px"}}><Badge c={u.plan==="pro"?"#00c9a7":"#ffffff44"} sm>{u.plan.toUpperCase()}</Badge></td>
    ...
    <div className="fade">
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:13,marginBottom:22}}>
        {[
          ...
          {l:"Day Streak",v:"1 🔥",c:"#f59e0b",s:"Keep going!"},
          plan==="free"&&aiLeft!==null?{l:"AI Left Today",v:aiLeft,c:aiLeft>2?"#00c9a7":"#ef4444",s:`of ${CONFIG.FREE_AI_LIMIT} free/day`}:{l:"Plan",v:"PRO ⚡",c:"#00c9a7",s:"Unlimited"},
        ].map(s=>(
          <Card key={s.l} style={{padding:16}}>
            <div style={{fontSize:10,color:"#ffffff33",letterSpacing:2,marginBottom:8}}>{s.l.toUpperCase()}</div>
      ...
      {plan==="free"&&(
        <div style={{background:"linear-gradient(135deg,#00c9a710,#7c3aed10)",border:"1px solid #00c9a730",borderRadius:14,padding:16,marginBottom:20,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12}}>
          <div>
            ...
            <div style={{fontSize:12,color:"#ffffff44",marginTop:4}}>Unlimited AI + mock tests for just {CONFIG.PRO_PRICE_DISPLAY}/month</div>
          </div>
...
// ═══════════════════════════════════════════════════════
//  DT LAB TAB — Full assignments from document
// ═══════════════════════════════════════════════════════
function DTLabTab(){
  ...
  if(!selQ) return (
    <div className="fade">
      <h2 style={{fontSize:17,fontWeight:600,color:"#fff",marginBottom:4}}>Database Technologies Lab</h2>
      <p style={{color:"#ffffff44",fontSize:12,marginBottom:6}}>March 2026 Lab Assignment — All 4 Questions</p>
      <div style={{background:"#06b6d410",border:"1px solid #06b6d430",borderRadius:10,padding:12,marginBottom:20,fontSize:12,color:"#67e8f9",lineHeight:1.7}}>
        📌 These are your actual lab assignment questions from the document. Each question has complete SQL solution + MongoDB CRUD.
      </div>
      {DT_LABS.map(q=>(
        <Card key={q.id} onClick={()=>{setSelQ(q);setSelPart(null);}} style={{marginBottom:12,cursor:"pointer"}} glow="#06b6d4">
          <div style={{fontWeight:600,fontSize:14,color:"#fff",marginBottom:6}}>{q.title}</div>
          <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
            {q.parts.map((p,i)=><Badge key={i} c="#06b6d4" sm>Part {p.label.split(".")[0]}</Badge>)}
          </div>
        </Card>
      ))}
    </div>
  ...
  if(!selPart) return (
    <div className="fade">
      <div style={{display:"flex",gap:9,alignItems:"center",marginBottom:20}}>
        <Btn sm onClick={()=>setSelQ(null)} c="#ffffff44">← Questions</Btn>
        <span style={{fontWeight:600,color:"#fff",fontSize:15}}>{selQ.title}</span>
      </div>
      {selQ.parts.map((p,i)=>(
        <Card key={i} onClick={()=>{setSelPart(p);setShowSol(false);}} style={{marginBottom:10,cursor:"pointer"}} glow="#06b6d4">
          <div style={{fontWeight:600,color:"#06b6d4",fontSize:12,marginBottom:6}}>{p.label}</div>
          <div style={{fontSize:13,color:"#dde1f0"}}>{p.question}</div>
        </Card>
      ))}
    </div>
  );
  ...
  return (
    <div className="fade">
      <div style={{display:"flex",gap:9,alignItems:"center",marginBottom:16,flexWrap:"wrap"}}>
        <Btn sm onClick={()=>setSelPart(null)} c="#ffffff44">← Parts</Btn>
        <span style={{fontWeight:600,color:"#06b6d4",fontSize:13}}>{selPart.label}</span>
      </div>
      <div style={{background:"#ffffff06",border:"1px solid #ffffff0d",borderRadius:12,padding:16,marginBottom:16}}>
        <div style={{fontSize:11,color:"#ffffff44",marginBottom:6,letterSpacing:1}}>QUESTION</div>
        <div style={{fontSize:14,color:"#fff",lineHeight:1.6}}>{selPart.question}</div>
      </div>
      <div style={{background:"#06b6d410",border:"1px solid #06b6d430",borderRadius:10,padding:12,marginBottom:16,fontSize:12,color:"#67e8f9",lineHeight:1.75}}>
        💡 {selPart.explain}
      </div>
      <div style={{display:"flex",gap:8,marginBottom:14}}>
        <button onClick={()=>setShowSol(!showSol)}
          style={{padding:"10px 20px",background:showSol?"#06b6d422":"#ffffff0a",border:`1px solid ${showSol?"#06b6d444":"#ffffff22"}`,borderRadius:9,color:showSol?"#06b6d4":"#ffffff88",cursor:"pointer",fontSize:12,fontWeight:600}}>
          {showSol?"Hide Solution":"🔑 Show Solution"}
        </button>
      </div>
      {showSol&&(
        <div className="fade">
          <pre style={{background:"#090d1a",border:"1px solid #06b6d420",borderRadius:12,padding:18,fontSize:12,color:"#67e8f9",lineHeight:1.85,overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",fontFamily:"monospace"}}>
            {selPart.solution}
          </pre>
        </div>
      )}
...
// ═══════════════════════════════════════════════════════
//  LAB TAB — Python DSA Labs (all 9)
// ═══════════════════════════════════════════════════════
function LabTab({plan,tryAI,recordAI}){
  const [selLab,setSelLab]=useState(null);
  const [code,setCode]=useState("");
  const [view,setView]=useState("learn"); // learn | code | solution | expected
  ...
  const evaluate=()=>tryAI(async()=>{
    ...
    try{
      const r=await callAI([{role:"user",content:`Evaluate this Python code for MCA DSA lab.
EXERCISE: ${selLab.title}
STUDENT CODE:\n${code}
MODEL SOLUTION:\n${selLab.solution}

Reply:
CORRECTNESS: [n]/10
✅ WHAT'S WORKING: [point]
🐛 BUGS/ISSUES: [issue]
💡 HOW TO FIX: [fix]
📊 OUTPUT: [what code would output]
📝 GRADE: [A/B/C/D]`}],"Friendly MCA DSA lab evaluator. Simple English. Be encouraging.");
      setFb(r);recordAI();
    }catch(e){
      if(e.message==="NO_KEY")setErr("No API key. Go to ⚙ Settings → add your Anthropic API key.");
  ...
  if(!selLab) return (
    <div className="fade">
      <h2 style={{fontSize:17,fontWeight:600,color:"#fff",marginBottom:4}}>Python DSA Lab</h2>
      <p style={{color:"#ffffff44",fontSize:12,marginBottom:6}}>Advanced Data Structures & Python Programming Lab — All 9 Programs</p>
      <div style={{background:"#84cc1610",border:"1px solid #84cc1630",borderRadius:10,padding:12,marginBottom:20,fontSize:12,color:"#bef264",lineHeight:1.7}}>
        📌 Don't worry if you don't understand DSA! Each exercise has a simple real-life explanation before the code. Start from Lab 1 and go step by step.
      </div>
      {PYTHON_DSA_LABS.map(lab=>(
        <Card key={lab.id} onClick={()=>{setSelLab(lab);setCode(lab.starter);setFb(null);setView("learn");setErr("");}} style={{marginBottom:10,cursor:"pointer"}} glow="#84cc16">
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div>
              <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:6}}>
                <Badge c="#84cc16" sm>Lab {lab.no}</Badge>
                <span style={{fontWeight:600,fontSize:14,color:"#fff"}}>{lab.title}</span>
              </div>
              <div style={{fontSize:12,color:"#ffffff44"}}>{lab.concept.split("—")[0]}</div>
            </div>
  ...
  return (
    <div className="fade">
      <div style={{display:"flex",gap:9,alignItems:"center",marginBottom:14}}>
        <Btn sm onClick={()=>setSelLab(null)} c="#ffffff44">← Labs</Btn>
        <Badge c="#84cc16" sm>Lab {selLab.no}</Badge>
        <span style={{fontWeight:600,color:"#fff",fontSize:14}}>{selLab.title}</span>
      </div>

      {/* Tabs */}
      <div style={{display:"flex",gap:6,marginBottom:16,flexWrap:"wrap"}}>
        {[["learn","🧠 Understand First"],["code","✏️ Your Code"],["solution","🔑 Solution"],["expected","📊 Expected Output"]].map(([t,l])=>(
          <button key={t} onClick={()=>setView(t)}
            style={{background:view===t?"#ffffff12":"transparent",border:`1px solid ${view===t?"#ffffff22":"transparent"}`,color:view===t?"#fff":"#ffffff44",cursor:"pointer",padding:"8px 14px",borderRadius:8,fontSize:11,transition:"all .18s"}}>
            {l}
          </button>
        ))}
      </div>
      ...
      {view==="learn"&&(
        <div className="fade">
          <div style={{background:"#84cc1610",border:"1px solid #84cc1630",borderRadius:12,padding:20,marginBottom:14}}>
            <div style={{fontSize:11,color:"#84cc16",letterSpacing:2,marginBottom:10,fontWeight:700}}>🧠 UNDERSTAND THE CONCEPT FIRST</div>
            <div style={{fontWeight:600,color:"#fff",fontSize:14,marginBottom:8}}>{selLab.concept}</div>
            <div style={{fontSize:12,color:"#bef264",lineHeight:1.85}}>
              <strong style={{color:"#fff"}}>🏠 Real Life Example:</strong><br/>
              {selLab.realLife}
            </div>
          </div>
          <div style={{background:"#ffffff06",border:"1px solid #ffffff0d",borderRadius:12,padding:18,fontSize:12,color:"#ffffff88",lineHeight:1.85}}>
            <div style={{fontWeight:600,color:"#fff",marginBottom:10,fontSize:13}}>📋 What you need to do in this lab:</div>
            {selLab.starter.split("\n").filter(l=>l.includes("# TODO")).map((l,i)=>(
              <div key={i} style={{display:"flex",gap:8,marginBottom:6}}>
                <span style={{color:"#84cc16",flexShrink:0}}>▸</span>
                <span>{l.replace("# TODO:","").replace("# TODO","").trim()}</span>
              </div>
            ))}
          </div>
          <div style={{marginTop:14}}>
            <Btn onClick={()=>setView("code")} c="#84cc16">Start Coding →</Btn>
          </div>
        </div>
      )}
      ...
      {view==="code"&&(
        <div className="fade">
          <textarea value={code} onChange={e=>setCode(e.target.value)} rows={18}
            style={{width:"100%",background:"#090d1a",border:"1px solid #ffffff12",borderRadius:12,padding:15,color:"#84cc16",fontSize:12,lineHeight:1.85,resize:"vertical",outline:"none",fontFamily:"monospace"}}/>
          <div style={{marginTop:11,display:"flex",gap:10,flexWrap:"wrap"}}>
            ...
            <Btn sm onClick={()=>setCode(selLab.starter)} c="#ffffff44">Reset</Btn>
            <Btn sm onClick={()=>setView("solution")} c="#ffffff44">See Solution</Btn>
          </div>
          ...
          {fb&&(
            <div className="fade" style={{marginTop:18,background:"#ffffff05",border:"1px solid #ffffff0d",borderRadius:14,padding:20}}>
              <div style={{fontWeight:600,color:"#00c9a7",fontSize:12,letterSpacing:1,marginBottom:12}}>◈ AI CODE FEEDBACK</div>
              <AIText text={fb}/>
            </div>
          )}
        </div>
      ...
      {view==="solution"&&(
        <div className="fade">
          <div style={{background:"#7c3aed10",border:"1px solid #7c3aed30",borderRadius:10,padding:12,marginBottom:12,fontSize:12,color:"#c4b5fd",lineHeight:1.7}}>
            💡 Try writing the code yourself first! Looking at solution is okay, but understanding it line by line is important.
          </div>
          <pre style={{background:"#090d1a",border:"1px solid #a78bfa30",borderRadius:12,padding:16,fontSize:12,color:"#a78bfa",lineHeight:1.85,overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",fontFamily:"monospace"}}>
            {selLab.solution}
          </pre>
        </div>
      )}
      ...
      {view==="expected"&&(
        <div className="fade">
          <div style={{fontSize:11,color:"#ffffff44",marginBottom:10,letterSpacing:1}}>EXPECTED OUTPUT</div>
          <pre style={{background:"#090d1a",border:"1px solid #ffffff12",borderRadius:12,padding:16,fontSize:12,color:"#6ee7b7",lineHeight:1.85,fontFamily:"monospace",whiteSpace:"pre-wrap"}}>
            {selLab.expected}
          </pre>
        </div>
      )}
...
function LearnTab({data,setData,plan,tryAI,recordAI}){
  ...
  const markDone=id=>setData({...data,progress:{...(data.progress||{}),[id]:{completed:true,at:Date.now()}}});

  const SYSTEM=`You are a super friendly MCA tutor for a complete beginner student. STRICT RULES:
- Very simple English. No difficult words at all.
- If you use ANY technical word, immediately explain it simply in brackets like: Stack (Stack = a pile of books where you take from top only)
- ALWAYS give TWO examples: 1) REAL LIFE EXAMPLE from daily life (food, phone, college) 2) REAL-TIME COMPUTER EXAMPLE (how actual software uses it)
- Never just define — show WHY and HOW step by step
- For DSA topics especially — use very simple analogies. Assume student knows NOTHING about coding.
- Be warm and encouraging like a helpful friend`;
...
## 🏠 REAL LIFE EXAMPLE
[A fun story from daily life. NOT computer related. Very relatable!]

## 💻 REAL-TIME COMPUTER EXAMPLE
[How a real app/software uses this RIGHT NOW. Name the actual app.]

## 🔢 HOW IT WORKS — STEP BY STEP
[Numbered steps. Simple language. If DSA, show with small example like array of 3-4 numbers. Add ASCII diagram if helpful.]

## ❓ WHY DO WE NEED IT?
[What problem does it solve? What would happen without it?]

## 🎯 KEY EXAM POINTS (must write these in exam!)
[5-7 bullet points examiners look for]

## ⚡ QUICK REVISION — Read before exam
[Only 3-4 lines summary]`,
      exam:`Exam writing guide for "${t.title}" from "${s.title}".

## 📋 QUESTION TYPES & MARKS
## ✅ WHAT TO WRITE FOR EACH MARK
**2 marks:** [exact points needed]
**5 marks:** [structure + points]
**10 marks:** [full structure]
**13 marks:** [complete coverage]
## 📝 SAMPLE STRUCTURE (5 marks)
## ⚠️ COMMON MISTAKES TO AVOID`,
      glossary:`Simple word dictionary for "${t.title}" from "${s.title}".
For each term: **[TERM]** = [One simple sentence] 📌 Example: [tiny example]
List 8-10 terms. Very simple language.`,
    };
    try{
      const res=await callAI([{role:"user",content:prompts[m]}],SYSTEM);
      setContent(res);recordAI();
    }catch(e){
      if(e.message==="NO_KEY")setErr("No API key! Go to ⚙ Settings → add your free Anthropic API key.");
      else setErr(`Could not load: ${e.message}. Check ⚙ Settings.`);
    }
    setLoading(false);
  });
  ...
  if(!sub) return (
    <div className="fade">
      ...
      <p style={{color:"#ffffff44",fontSize:12,marginBottom:6}}>AI explains every topic simply with real-life + computer examples 🙂</p>
      <div style={{background:"#00c9a710",border:"1px solid #00c9a730",borderRadius:10,padding:12,marginBottom:18,fontSize:12,color:"#6ee7b7",lineHeight:1.7}}>
        💡 Struggling with DSA? Don't worry! Click any DSA topic → AI will explain from scratch with simple examples you can actually understand!
      </div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:13}}>
        {SUBJECTS.map(s=>{
      ...
      <div style={{background:"#ffffff05",border:"1px solid #ffffff0d",borderRadius:14,padding:22,minHeight:260}}>
        {loading?(
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:14,padding:50,color:"#ffffff33"}}>
            ...
            <div style={{fontSize:11,color:"#ffffff22"}}>Usually 5–15 seconds 🙏</div>
          </div>
        ):err?(
          ...
          <div style={{textAlign:"center",padding:40}}>
            ...
            <div style={{color:"#ffffff44",fontSize:13,marginBottom:8}}>Click below to load AI explanation</div>
            {s2.id==="ds"&&<div style={{fontSize:12,color:"#00c9a7",marginBottom:16}}>💡 DSA topics will be explained from absolute basics with simple examples!</div>}
...
function PracticeTab({data,setData,plan,tryAI,recordAI}){
  ...
  const getHint=()=>tryAI(async()=>{
    ...
    try{
      const r=await callAI([{role:"user",content:`Give a 3-4 line hint in VERY simple English for: "${q.question}". Just a nudge — don't give the full answer.`}],"Helpful tutor. Simple hints only.");
      setHint(r);recordAI();
...
🔁 PERFECT ANSWER HAS:\n[2-3 lines]`}]," evaluator. Simple English. Kind and specific.");
      ...
      setData({...data,scores:[...(data.scores||[]),{id:topic.id,got,max:q.marks,date:Date.now()}]});
      recordAI();
    }catch(e){
  ...
  return (
    <div className="fade">
      ...
      <textarea value={ans} onChange={e=>setAns(e.target.value)} rows={9}
        placeholder={`Write your ${q.marks}-mark answer here...\n\nTip: Write in your own words — that's how you actually learn!`}
      ...
      <div style={{marginTop:12,display:"flex",gap:10,flexWrap:"wrap"}}>
        <Btn onClick={evaluate} disabled={loading||!ans.trim()} c="#00c9a7">
          {loading?<><Spin/> Evaluating...</>:"◈ Submit for AI Evaluation"}
        </Btn>
        ...
        <div className="fade" style={{marginTop:20,background:"#ffffff05",border:"1px solid #ffffff0d",borderRadius:14,padding:22}}>
          <div style={{display:"flex",gap:14,alignItems:"center",marginBottom:18,background:"#ffffff08",borderRadius:10,padding:"12px 16px"}}>
            ...
            <div>
              ...
              <div style={{fontSize:11,color:"#ffffff44"}}>{Math.round((result.got/q.marks)*100)}% — {result.got/q.marks>=0.7?"Great! 🎉":result.got/q.marks>=0.4?"Getting there! 💪":"Revise and retry 📖"}</div>
            </div>
          </div>
    ...
    <div className="fade">
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,position:"sticky",top:0,background:"#07070e",padding:"8px 0",zIndex:10}}>
        ...
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          ...
          <Btn sm onClick={handleSubmit} danger>Submit</Btn>
        </div>
      </div>
